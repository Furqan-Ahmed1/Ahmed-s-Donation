<html lang="en" class="fontawesome-i2svg-active fontawesome-i2svg-complete"><head>
       <link rel="shortcut icon" href="{{ asset('asset/image/Latest_logo.png') }}" type="image/x-icon">
        ...
        <title>Ahmed Donation homepage</title>
        <link rel="stylesheet" type="text/css" href="{{ asset('asset/css/styles.css') }}" >
        <script src="{{ asset('asset/js/scripts.js') }}"></script>
        <link rel="stylesheet" type="text/css" href="{{ asset('asset/js/scripts.js') }}" >
        <!-- Favicon--> 
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" id="mainNav">
            <div class="container">
                <a class="navbar-brand js-scroll-trigger" href="#page-top"><img width=70 height=50 src="{{ asset('asset/image/Latest_logo.png') }}">AHMED FOUNDATION</a>
            ...
            <div class="container h-100">
                <div class="row h-100 align-items-center justify-content-center text-center">
                    <div class="col-lg-10 align-self-end">
                        <h1 class="text-uppercase text-white font-weight-bold">Supporting and Inspiring Millions</h1>
                        <hr class="divider my-4">
                    </div>
                    <div class="col-lg-8 align-self-baseline">
                        <p class="text-white-75 font-weight-light mb-5">Suport us to help them</p>
            ...
            <div class="container" >
                <div class="row justify-content-center">
                    <div class="col-lg-8 text-center">
                        <h2 class="text-black mt-0">We've got everything that you need!</h2>
                        <hr class="divider light my-4">
                        <p class="text-white-50 mb-4">AHMED FOUNDATION deals with a diversed set of domains to give donations in</p>
                        <a class="btn btn-light btn-xl js-scroll-trigger" href="#services">View Our Services</a>
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6 text-center">
                        <div class="mt-5">
                            ...
                            <h3 class="h4 mb-2">Money Donation</h3>
                            <p class="text-muted mb-0">With your money we support hundreds of lives</p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 text-center">
                        <div class="mt-5">
                            ...
                            <h3 class="h4 mb-2">Items & Supplies Donation</h3>
                            <p class="text-muted mb-0">Your give away brings happines to somebody's face.</p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 text-center">
                        <div class="mt-5">
                            ...
                            <h3 class="h4 mb-2">Blood Donation</h3>
                            <p class="text-muted mb-0">Hundred of live can be save with every bottle that you donate</p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 text-center">
                        <div class="mt-5">
                            ...
                            <h3 class="h4 mb-2">Organ Donation</h3>
                            <p class="text-muted mb-0">your organ can be someone's life</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container-fluid p-0">
                <div class="row no-gutters">
                    <div class="col-lg-4 col-sm-6">
                        <a class="portfolio-box" href="{{ asset('asset/image/pic1.jpg') }}">
                            <img class="img-fluid" src="{{ asset('asset/image/pic1.jpg') }}" alt="">
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <a class="portfolio-box" href="{{ asset('asset/image/pic2.jpg') }}">
                            <img class="img-fluid" src="{{ asset('asset/image/pic2.jpg') }}"alt="">
                            <div class="portfolio-box-caption">
                                <div class="project-category text-white-50">Category</div>
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <a class="portfolio-box" href="{{ asset('asset/image/pic3.jpg') }}">
                            <img class="img-fluid" src="{{ asset('asset/image/pic3.jpg') }}" alt="">
                            <div class="portfolio-box-caption">
                                <div class="project-category text-white-50">Category</div>
                                <div class="project-name">Project Name</div>
                            </div>
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <a class="portfolio-box" href="{{ asset('asset/image/pic4.jpg') }}">>
                            <img class="img-fluid" src="{{ asset('asset/image/pic4.jpg') }}" alt="">
                            <div class="portfolio-box-caption">
                                <div class="project-category text-white-50">Category</div>
                                <div class="project-name">Project Name</div>
                            </div>
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <a class="portfolio-box" href="{{ asset('asset/image/pic5.jpg') }}">>
                            <img class="img-fluid" src="{{ asset('asset/image/pic5.jpg') }}" alt="">
                            <div class="portfolio-box-caption">
                                <div class="project-category text-white-50">Category</div>
                                <div class="project-name">Project Name</div>
                            </div>
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <a class="portfolio-box" href="{{ asset('asset/image/pic6.jpg') }}">>
                            <img class="img-fluid" src="{{ asset('asset/image/pic6.jpg') }}" alt="">
        ...
        <section class="page-section bg-dark text-white">
            <div class="container text-center">
                <h2 class="mb-4">Support Us with your Donations</h2>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-8 text-center">
                        ...
                        <hr class="divider my-4">
                        <p class="text-muted mb-5">We are at your service 24/7, feel free to contact us at anytime you want.</p>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-lg-4 mr-auto text-center">
                        ...
                        <a class="d-block" href="mailto:contact@yourwebsite.com">AhmedFoundation@email.com</a>
                    </div>
                </div>
            </div>
        </section>
        ...
        <footer class="bg-light py-5">
            <div class="container"><div class="small text-center text-muted">AHMED FOUNDATION, trusted non-profit organization</div></div>
        </footer>
        <!-- Bootstrap core JS-->
